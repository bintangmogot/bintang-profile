  ...
  <main class="w-full flex flex-col">
    ...
    <div id="content" class="relative z-10">
      ...
      <section id="contact" class="py-20 text-center border-t border-white/5">
        ...
        <!-- Footer Socials -->
        <div class="flex justify-center space-x-6 mt-8 text-slate-900">
          <a href="https://github.com/bintangmogot" target="_blank" rel="noopener noreferrer" class="bg-primary hover:bg-primary-hover hover:text-white/80 p-2 rounded-sm transition-colors">
          ...
          <a href="https://www.instagram.com/bintang_s.a.m/" target="_blank" rel="noopener noreferrer" class="bg-primary hover:bg-primary-hover hover:text-white/80 p-2 rounded-sm transition-colors">
          ...
          <a href="https://wa.me/62895353811311" target="_blank" rel="noopener noreferrer" class="bg-primary hover:bg-primary-hover hover:text-white/80 p-2 rounded-sm transition-colors">
          ...
          <a href="https://www.linkedin.com/in/contact-bintangsurya/" target="_blank" rel="noopener noreferrer" class="bg-primary hover:bg-primary-hover hover:text-white/80 p-2 rounded-sm transition-colors">
        ...
        <p class="text-gray-500 mt-8 text-sm">© 2026 Bintang Surya. All rights reserved.</p>
      </section>
    </div>
  </main>
</template>
