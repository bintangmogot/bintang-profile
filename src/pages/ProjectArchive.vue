...
const techIcons = {
  // Frontend
  'Next.js': '<path d="M18.665 21.978l-10-15.42h-1.665v15.42h2v-11.71l8.175 12.585c.485-.145.955-.305 1.49-.875zM22 12c0 5.523-4.477 10-10 10-.705 0-1.395-.07-2.06-.205l12.06-15.545c.205.665.205 1.355.205 2.06zM2 12c0-5.523 4.477-10 10-10 .705 0 1.395.07 2.06.205l-12.06 15.545c-.205-.665-.205-1.355-.205-2.06zM15 15v-8.5h2v8.5h-2z"/>',
  'GSAP': '<path d="M12 24c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8zm0-14c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6zM8 16h8v-2H8v2zm0-4h8v-2H8v2zM12 4C5.4 4 0 9.4 0 16s5.4 12 12 12 12-5.4 12-12S18.6 4 12 4z"/>',
  'Vue 3': '<path d="M24,1.61H14.06L12,5.16,9.94,1.61H0L12,22.39ZM12,14.08,5.16,2.23H9.59L12,6.41l2.41-4.18h4.43Z"/>',
  'Vue.js': '<path d="M24,1.61H14.06L12,5.16,9.94,1.61H0L12,22.39ZM12,14.08,5.16,2.23H9.59L12,6.41l2.41-4.18h4.43Z"/>',
  ...
  'JavaScript': '<path d="M0 0h24v24H0V0zm22.034 18.268c-.147-.851-.715-1.426-1.848-1.841l-.932-.34c-.543-.2-.843-.361-.843-.722 0-.317.27-.512.75-.512.451 0 .736.166.931.527l1.397-.883c-.346-.662-1.022-1.127-2.134-1.127-1.638 0-2.585.901-2.585 2.103 0 1.292.811 1.833 2.059 2.284l.872.329c.69.255.916.481.916.856 0 .42-.391.662-.976.662-.735 0-1.127-.331-1.353-.872l-1.474.825c.376.842 1.112 1.503 2.825 1.503 1.893 0 2.924-1.007 2.924-2.56zm-11.006.18h-1.488c-.015-.751-.105-1.142-.511-1.142-.3 0-.495.166-.495.736v2.18c0 .54.195.705.48.705.405 0 .495-.391.51-1.096h1.488c-.015 1.456-.705 2.103-2.01 2.103-1.696 0-1.951-1.006-1.951-2.177v-2.012c0-1.293.301-2.104 1.996-2.104 1.472 0 1.997.72 1.981 2.105z"/>',
  'Vite': '<path d="M18.098 12.338l-4.59-1.393L12 9.444l-1.508 1.5l-4.59 1.394L12 24zM24 0H0l3.18 5.672L12 2.138l8.82 3.534L24 0z"/>',
  'HTML5': '<path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.138-1.579H6.142l.254 3.11 5.56 1.547 5.594-1.548.783-8.688H8.531z"/>',
  'CSS3': '<path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm5.09 14.593l.131 1.522 5.256 1.455 5.289-1.456.65-7.241H6.11l-.225-2.585h13.21l.23-2.585H3.016l.68 7.756h9.324l-.24 2.682-2.802.775-2.836-.776-.172-1.927H6.59z"/>',
  'Bootstrap': '<path d="M0 4.8c0-2.651 2.149-4.8 4.8-4.8h14.4c2.651 0 4.8 2.149 4.8 4.8v14.4c0 2.651-2.149 4.8-4.8 4.8h-14.4c-2.651 0-4.8-2.149-4.8-4.8v-14.4zm7.043 14h4.417c2.147 0 3.197-.833 3.197-2.318 0-1.442-.947-2.012-2.174-2.102 1.011-.186 1.776-.826 1.776-1.939 0-1.347-.946-2.141-2.859-2.141h-4.357v8.5zm1.531-4.908V10.46h2.515c1.118 0 1.631.391 1.631 1.054 0 .759-.622 1.104-1.631 1.104h-2.515zm0 3.398v-2.384h2.74c1.238 0 1.831.42 1.831 1.145 0 .807-.636 1.239-1.831 1.239h-2.74z"/>',
  'Astro': '<path d="M12 0c-1.3 0-2.3 1-2.3 2.3 0 1.3 1 2.3 2.3 2.3 1.3 0 2.3-1 2.3-2.3C14.3 1 13.3 0 12 0zm0 6C5.4 6 0 11.4 0 18s5.4 12 12 12 12-5.4 12-12S18.6 6 12 6zm0 2c5.5 0 10 4.5 10 10s-4.5 10-10 10S2 23.5 2 18 6.5 8 12 8zm0 2.5c-4.1 0-7.5 3.4-7.5 7.5S7.9 25.5 12 25.5s7.5-3.4 7.5-7.5-3.4-7.5-7.5-7.5z"/>',
  
  // Backend & DB
  'Laravel': '<path d="M24 15.602l-1.928-1.927a.91.91 0 0 0-.64-.265H20.44l-.24.238L18.973 15h-.973v1.6l-1.6 1.6V20h5.6a1.6 1.6 0 0 0 1.6-1.6v-2.798zM2 13.6h2.4v2.4H2v-2.4zm22-3.2l-1.928-1.927a.91.91 0 0 0-.64-.265H20.44l-.24.238L18.973 10V8.4l-1.6-1.6H12V2.8a.8.8 0 0 0-.8-.8H8.8l-1.6-1.6H1.6A1.6 1.6 0 0 0 0 2v10.4h2.4v-8h3.2v3.2H8v2.4l1.6 1.6v5.6a1.6 1.6 0 0 0 1.6 1.6h5.6a1.6 1.6 0 0 0 1.6-1.6v-4h4.4v4h1.6L24 13.2V10.4z"/>',
  'PHP': '<path d="M2.35 15.11a3.09 3.09 0 0 1 0-.74c.2-.55.76-.87 1.25-.87h1.4c.55 0 1.05.32 1.2.75l1.1 3c.15.4.05.85-.25 1.15a1.5 1.5 0 0 1-1.05.45c-.5 0-.9-.35-1.05-.8l-.3-.85h-2.1l-.3.85c-.15.45-.55.8-1.05.8a1.5 1.5 0 0 1-1.05-.45c-.3-.3-.4-.75-.25-1.15l1.1-3.2-.2-1l-1-2.9c-.1-.3-.05-.65.15-.9.2-.25.5-.4.8-.4h2.1c.3 0 .6.15.8.4.2.25.25.6.15.9l-.65 1.9h2.3l-.65-1.9c-.1-.3-.05-.65.15-.9.2-.25.5-.4.8-.4H13c.3 0 .6.15.8.4.2.25.25.6.15.9l-1 2.9-.2 1 1.1 3.2c.15.4.05.85-.25 1.15-.3.3-.75.45-1.15.45-.5 0-.9-.35-1.05-.8l-.3-.85H8.85l-.3.85c-.15.45-.55.8-1.05.8-.4 0-.8-.15-1.1-.45-.3-.3-.45-.75-.3-1.15l1.3-3.75z"/>',
  'MySQL': '<path d="M12 21c-4.418 0-8-1.007-8-2.25V17c0 1.243 3.582 2.25 8 2.25s8-1.007 8-2.25v1.75c0 1.243-3.582 2.25-8 2.25zm0-4.5c-4.418 0-8-1.007-8-2.25V12.5c0 1.243 3.582 2.25 8 2.25s8-1.007 8-2.25V14.25c0 1.243-3.582 2.25-8 2.25zm0-4.5c-4.418 0-8-1.007-8-2.25V8c0 1.243 3.582 2.25 8 2.25s8-1.007 8-2.25V9.75c0 1.243-3.582 2.25-8 2.25zM12 3c-4.418 0-8 1.007-8 2.25s3.582 2.25 8 2.25 8-1.007 8-2.25S16.418 3 12 3z"/>',
  
  // CMS & Platforms
  'WordPress': '<path d="M12.158 12.786l-2.698 7.84c.806.236 1.657.365 2.54.365 1.047 0 2.051-.181 2.986-.51-.102-.23-.286-.871-.471-1.336l-2.357-6.359zm.411-2.1l2.308 6.694c.504-1.298.887-2.622.887-4.148 0-1.428-.244-3.57-1.428-3.57-.42 0-.773.235-1.008.672-.253.487-.336 1.226-.336 1.83.001.168.017.336.035.522h.013c.091-.017.184-.017.278-.017.655 0 1.192.522 1.192 1.176 0 .656-.537 1.177-1.192 1.177-.101 0-.184-.017-.278-.05zm-5.048-1.564c-.454 0-.84.236-1.043.623-.218.421-.286 1.027-.286 1.549s.068 1.128.286 1.549c.203.388.589.624 1.043.624.453 0 .84-.236 1.042-.624.219-.421.287-1.027.287-1.549s-.068-1.128-.287-1.549c-.202-.387-.589-.623-1.042-.623zm17.479 2.878c0-5.523-4.477-10-10-10-5.523 0-10 4.477-10 10 0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10zM12 2C6.486 2 2 6.486 2 12c0 1.956.561 3.774 1.527 5.31l3.078-8.484C7.305 6.68 8.441 5.3 10.422 5.3c.184 0 .369.017.554.034.202.034.404.05.623.05 1.042 0 1.68-.655 1.68-1.428 0-.303-.083-.588-.235-.84l-.101-.168C12.639 2.115 12.319 2 12 2zm3.361 14.504l1.63 4.504c2.251-2.1 3.655-5.127 3.655-8.508 0-1.884-.37-3.666-1.042-5.31l-4.243 9.314z"/>',
  'Elementor Pro': '<path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zm1.25 6h-2.5v2.5h2.5V8zm2.5 0h-2.5v2.5h2.5V8zm-5 0h-2.5v2.5h2.5V8zm0 5h-2.5v2.5h2.5V13zm2.5 0h-2.5v2.5h2.5V13zm2.5 0h-2.5v2.5h2.5V13z"/>',
  'WooCommerce': '<path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2zm0 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm-5-5h10V9H7v2zm0 4h10v-2H7v2z"/>',
  'Tutor LMS': '<path d="M12 0L1.5 6v12L12 24l10.5-6V6L12 0zm0 3.1l7.5 4.3v9.2L12 20.9l-7.5-4.3V7.4L12 3.1zM12 7l-5.5 3.1v3.8L12 17l5.5-3.1v-3.8L12 7z"/>',
  
  // Tools
  'Figma': '<path d="M12 24c3.314 0 6-2.686 6-6V6c0-3.314-2.686-6-6-6S6 2.686 6 6v12c0 3.314 2.686 6 6 6zM9 6c0-1.657 1.343-3 3-3s3 1.343 3 3-1.343 3-3 3-3-1.343-3-3zm0 12c0-1.657 1.343-3 3-3s3 1.343 3 3-1.343 3-3 3-3-1.343-3-3z"/>',
};
