...
const archiveProjects = ref([
  {
    ...
    linkDisplay: 'bintang.dev',
    liveLink: 'https://example.com',
    githubLink: 'https://github.com',
    media: 'https://images.unsplash.com/photo-1555066931-4365d14431b9?w=800&q=80',
    longDescription: 'A personal portfolio website built with Vue 3 and Tailwind CSS, featuring smooth animations, a project archive page, and a contact form.',
    features: ['Scroll-triggered animations', 'Project archive with filter', 'Responsive design', 'Dark mode'],
  },
  {
    year: '2024',
    ...
    linkDisplay: 'design.agency.com',
    liveLink: 'https://example.com',
    githubLink: '',
    media: 'https://images.unsplash.com/photo-1551650975-87deedd944c3?w=800&q=80',
    longDescription: 'A comprehensive design system and documentation site built with React and Storybook for a large enterprise client.',
    features: ['Component library', 'Accessible components', 'Token management', 'Auto-generated docs'],
  },
  {
    year: '2024',
    ...
    longDescription: 'A full-featured e-commerce mobile application with real-time inventory, push notifications, and integrated payment processing via Stripe.',
    features: ['Push notifications', 'Stripe payment integration', 'Real-time inventory', 'Apple & Google Pay'],
  },
  {
    year: '2023',
    ...
    linkDisplay: 'analytics.example.com',
    liveLink: 'https://example.com',
    githubLink: 'https://github.com',
    media: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80',
    longDescription: 'A data analytics dashboard for tracking business KPIs with interactive charts, CSV export, and role-based access control.',
    features: ['Interactive charts', 'CSV export', 'Role-based access', 'Real-time data updates'],
  },
  {
    year: '2023',
    ...
    linkDisplay: 'launch.startup.io',
    liveLink: 'https://example.com',
    githubLink: '',
    media: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80',
    longDescription: 'A high-conversion marketing landing page for a SaaS product launch, featuring animated sections and an integrated waitlist form.',
    features: ['Waitlist form integration', 'Animated hero section', 'A/B testing support', 'Page speed optimized'],
  },
]);
